...
if __name__ == '__main__':
    ...
    b_params = []
    b_params.append(InitialStateParams(shape=(7, 7), player=(0, 1), key=(6, 2), pit_start=(3, 0), pit_end=(3, 4)))
    b_params.append(InitialStateParams(shape=(7, 7), player=(6, 5), lock=(0, 1), pit_start=(3, 2), pit_end=(3, 6)))
    b_params.append(InitialStateParams(shape=(10, 10), player=(1, 4), key=(7, 5), lock=(1, 1), pit_start=(4, 2),
                                                                   pit_end=(4, 7)))

    pre_agent = None
    source_param = None

    for index, param in enumerate(b_params):
